...
namespace BankTransactionWithjQuery.Controllers
{
    public class TransactionsController : Controller
    {
        ...
        public TransactionsController(OnlineBankDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("TransactionId,AccountNumber,BenificiaryName,BankName,SwiftCode,Amount,Date")] TransactionModel transactionModel)
        {
